...
function App() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <SelectionTag label="Selection" selected={selected} onSelect={() => console.log("Selected")} />
      ...
      <TextInput inputType="text" value="" onChange={(value) => console.log(value)} placeholder="Text input" />
      <TextInput inputType="search" value="" onChange={(value) => console.log(value)} placeholder="Search input" />
      <TextInput inputType="password" value="" onChange={(value) => console.log(value)} placeholder="Password input" />
      ...
      <Icon name={ICON_NAMES.footer_music} height={77} width={224.251} viewBox={"0 0 224.251 77.704"} />
      ...
      <Icon name={ICON_NAMES.instrument_icon} height={14.833} width={10.384} viewBox={"0 0 10.384 14.833"} />
      ...
      <Icon name={ICON_NAMES.no_results} height={97.656} width={140.932} viewBox={"0 0 140.932 97.656"} />
      ...
      <Icon name={ICON_NAMES.profile_welcome} height={159.24} width={153.993} viewBox="0 0 153.993 159.24" />
      <Icon name={ICON_NAMES.quote_mark_begin} height={16.44} width={19.32} viewBox="0 0 19.32 16.44" />
