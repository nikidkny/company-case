...
import { createCurrentUserSlice, CurrentUserState } from "./slices/currentUserSlice";
...
interface Store extends BearState, MenuState, LoginStatusState, CreateEnsembleState, FetchDataState, EnsemblesState, PopUpState, CurrentUserState {}
...
export const useStore = create<Store>((set, ...args) => ({
  ...
  ...createCurrentUserSlice(set, ...args), // Add the updated Auth slice here
