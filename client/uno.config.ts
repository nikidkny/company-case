...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "btn-tertiary":
      "bg-red-500 text-white border-solid border-1px border-red-500 hover:bg-red-400 hover:text-red-500",
    ...
    //text input
    "input-container":
      "flex items-center rounded-md p4 gap-2 border-1px border-solid transition-colors  border-gray-400 hover:border-gray-500 focus-within:border-gray-500 bg-white",
    "input-text":
      "w-full outline-none border-none bg-transparent text-gray-800 font-montserrat bg-white",
    // dropdown item
    "dropdown-item":
