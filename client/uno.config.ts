...
export default defineConfig({
  ...
  shortcuts: {
    ...
    // range input
    //textarea
    textarea: "border-1px border-solid border-gray-400 rounded-input p-4 text--body-md shadow-input hover:border-gray-500 focus:border-gray-500 focus-visible:border-gray-500 font-montserrat",
    //text input
    "input-container": "w-full flex items-center rounded-md p4 gap-2 border-1px border-solid transition-colors  border-gray-400 hover:border-gray-500 focus-within:border-gray-500 bg-white",
